...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    // Load stored data from Hive after first frame so any persisted channels
    // and programs are available for the UI. We intentionally do NOT add
    // sample channels or programs automatically.
  ...
  // Sample data loader removed — app starts with empty channels and
  // programs and relies solely on persisted user data.
